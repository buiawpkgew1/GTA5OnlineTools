...
using GTA5OnlineTools.Features.Config;
...
public partial class OptionView : UserControl
{
    ...
    public OptionView()
    {
        ...
        if (File.Exists(FileUtil.F_Option_Path))
        {
            using var streamReader = new StreamReader(FileUtil.F_Option_Path);
    ...
    {
        // 写入到Json文件
        File.WriteAllText(FileUtil.F_Option_Path, JsonUtil.JsonSeri(OptionConfig));
    }
